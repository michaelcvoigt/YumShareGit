...
namespace MalbersAnimations.Selector
{
    ...
    public class SelectorEditor : MonoBehaviour
    {
        ...
        public bool UseWorld = true;                         //this will keep always looking forward on the radial Style
        public bool LookRotation;                         //this will keep always looking forward on the radial Style
